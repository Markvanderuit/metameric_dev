...
const uint cl_bary_invoc_n = CEIL_DIV(barycentric_weights, cl_bary_values_n);
...
uint cl_bary_invoc_size = min(cl_bary_invoc_offs + cl_bary_values_n, barycentric_weights) - cl_bary_invoc_offs;
...
#define InBary float[barycentric_weights]
#define ClBary vec4
#define ClMask bvec4
