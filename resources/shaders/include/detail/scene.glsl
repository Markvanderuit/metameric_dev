#ifndef GLSL_SCENE_DETAIL_GUARD
#define GLSL_SCENE_DETAIL_GUARD

// scene_buff_mesh_vert
...
// scene_buff_emtr_info
// scene_buff_emtr_count

// scene_buff_objc_info
// scene_buff_objc_count

// scene_buff_bary_info
// scene_buff_bary_txtr
// scene_buff_spec_txtr

// scene_buff_wvls_distr
// scene_buff_emtr_distr
...
#define declare_scene_mesh_data(scene_buff_mesh_vert,                     \
                                ...
                                scene_buff_mesh_info,                     \
                                scene_buff_mesh_count)                    \
  BVHVertPack scene_mesh_vert(uint i) { return scene_buff_mesh_vert[i]; } \
  uvec3 scene_mesh_elem(uint i)       { return scene_buff_mesh_elem[i]; } \
  BVHPrimPack scene_mesh_prim(uint i) { return scene_buff_mesh_prim[i]; } \
...
#ifdef scene_buff_bary_info
  AtlasLayout scene_bary_info(uint i) { return scene_buff_bary_info[i]; }
  #define scene_uplifting_bary_texture() scene_buff_bary_txtr
  #define scene_uplifting_spec_texture() scene_buff_spec_txtr
#endif
