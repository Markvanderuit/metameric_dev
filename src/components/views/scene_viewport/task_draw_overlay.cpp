...
namespace met {
  ...
  bool ViewportDrawOverlayTask::is_active(SchedulerHandle &info) {
    return info.parent()("is_active").getr<bool>();
  }
  
  void ViewportDrawOverlayTask::init(SchedulerHandle &info) {
    met_trace_full();
    ...
    std::tie(m_program_key, std::ignore) = info.global("cache").getw<gl::detail::ProgramCache>().set({{ 
      ...
      .spirv_path = "shaders/views/scene_viewport/draw_paths.vert.spv",
      .cross_path = "shaders/views/scene_viewport/draw_paths.vert.json"
    }, {
      .type       = gl::ShaderType::eFragment,
      .spirv_path = "shaders/views/scene_viewport/draw_paths.frag.spv",
      .cross_path = "shaders/views/scene_viewport/draw_paths.frag.json"
    }});
  ...
  void ViewportDrawOverlayTask::eval_draw_constraints(SchedulerHandle &info) {
    met_trace_full();
  ...
  void ViewportDrawOverlayTask::eval_draw_frustrum(SchedulerHandle &info) {
    met_trace_full();
  ...
  void ViewportDrawOverlayTask::eval_draw_info(SchedulerHandle &info) {
    met_trace();
  ...
  void ViewportDrawOverlayTask::eval_draw_path_queries(SchedulerHandle &info) {
    met_trace_full();
  ...
  void ViewportDrawOverlayTask::eval(SchedulerHandle &info) {
    met_trace_full();
