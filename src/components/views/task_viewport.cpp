...
namespace met {
  ...
  void ViewportTask::init(SchedulerHandle &info) {
    ...
    info.child_task("view_begin").init<ViewportViewBeginTask>();
    info.child_task("overlay").init<ViewportOverlayTask>();
    info.child_task("input").init<ViewportInputTask>();
    info.child_task("view_end").init<ViewportViewEndTask>();
    info.child_task("draw_begin").init<ViewportDrawBeginTask>();
    info.child_task("draw_color_system_solid").init<ViewportDrawColorSystemSolid>();
