...
namespace met {
  namespace detail {
    ...
    size_t size_from_format(DynamicImage::PixelFormat fmt) {
      switch (fmt) {
        ...
        case DynamicImage::PixelFormat::eAlpha: return 1;
        default:                                return 0;
      }      
    }
    ...
    DynamicImage::PixelFormat format_from_size(size_t size) {
      switch (size) {
        ...
        case 1: return DynamicImage::PixelFormat::eAlpha;
        default: return DynamicImage::PixelFormat::eAlpha;
      }    
    }
  ...
  DynamicImage::DynamicImage(LoadInfo info) {
    met_trace();
  ...
  DynamicImage::DynamicImage(CreateInfo info)
  ...
  DynamicImage DynamicImage::convert(ConvertInfo info) const {
    met_trace();
