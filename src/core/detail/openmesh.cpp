...
// namespace met {
//   template <>
//   eig::Array2f convert_vector<eig::Array2f, omesh::Vec2f>(const omesh::Vec2f &v) {
//     return eig::Array2f(v.data());
//   }

//   template <>
//   omesh::Vec2f convert_vector<omesh::Vec2f, eig::Array2f>(const eig::Array2f &v) {
//     return omesh::Vec2f(v.begin());
//   }
