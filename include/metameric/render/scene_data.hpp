...
namespace met {
  namespace detail {
    ...
    // Non-virtual so it can be constructed as a resource handle in the scheduler
    struct BaseSceneData {
  ...
  struct TextureData : detail::BaseSceneData {
  ...
  // accompanying info blocks to read said data gl-side
  struct MeshData : detail::BaseSceneData {
    // Uniform object layout;
    // provides information for accessing parts of
  ...
  struct BVHData : detail::BaseSceneData {
    // Uniform object layout;
    // provides information for accessing parts of
  ...
  // accompanying info blocks to read said data gl-side
  struct ObjectData : detail::BaseSceneData {
    // Uniform object layout;
  ...
  struct UpliftingData : detail::BaseSceneData {
  ...
  struct ObserverData : detail::BaseSceneData {
  ...
  struct IlluminantData : detail::BaseSceneData {
  ...
  struct ColorSystemData : detail::BaseSceneData {
    using Texture1d3fArray = gl::Texture1d<float, 3, gl::TextureType::eImageArray>;
