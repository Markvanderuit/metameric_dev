...
namespace met {
  ...
  eig::Array4u pack_moments_12x10(const Moments &m) {
    eig::Array4u p;
    p[0] = detail::pack_half_2x16(m(eig::seqN(0, 2)));
    p[1] = detail::pack_half_2x16(m(eig::seqN(2, 2)));
    p[2] = detail::pack_half_2x16(m(eig::seqN(4, 2)));
    p[3] = detail::pack_half_2x16(m(eig::seqN(6, 2)));
    return p;
  ...
  Moments unpack_moments_12x10(const eig::Array4u &p) {
    Moments m;
    m(eig::seqN(0, 2)) = detail::unpack_half_2x16(p[0]);
    m(eig::seqN(2, 2)) = detail::unpack_half_2x16(p[1]);
    m(eig::seqN(4, 2)) = detail::unpack_half_2x16(p[2]);
    m(eig::seqN(6, 2)) = detail::unpack_half_2x16(p[3]);
    return m;
