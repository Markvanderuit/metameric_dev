...
namespace met::detail {
  ...
  public:
    ...
    void eval(SchedulerHandle &info) override {
      ...
      // TODO move to above! Combine with window size mismatch
      if (!i_frame_buffer_ms.is_init() || info("lrgb_target").is_mutated()) {
  ...
  public:
    ...
    void eval(SchedulerHandle &info) override {
      ...
      if (begin_handle("is_active").getr<bool>()) {
        ...
        begin_handle("frame_buffer_ms").getr<gl::Framebuffer>().blit_to(m_frame_buffer, 
