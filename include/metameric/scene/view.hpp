...
namespace met {
  ...
  struct View {
    ...
    float        camera_focus_distance = 0.f;   // Focus distance to the focal plane, ignored if 0
    float        camera_aperture_r     = .1f;   // Aperture radius if focus distance != 0
  ...
  public: // Boilerplate
    bool operator==(const View &o) const {
      ...
      return std::tie(draw_frustrum, observer_i, camera_trf, camera_fov_y, camera_focus_distance, camera_aperture_r)
          == std::tie(o.draw_frustrum, o.observer_i, o.camera_trf, o.camera_fov_y, o.camera_focus_distance, o.camera_aperture_r);
    }
  };
  ...
  namespace detail {
    ...
    struct SceneStateHandler<View> : public SceneStateHandlerBase<View> {
      ...
      SceneStateHandler<decltype(View::camera_focus_distance)> camera_focus_distance;
      SceneStateHandler<decltype(View::camera_aperture_r)>     camera_aperture_r;
    ...
    public:
      bool update(const View &o) override {
        ...
        | camera_focus_distance.update(o.camera_focus_distance)
        | camera_aperture_r.update(o.camera_aperture_r)
